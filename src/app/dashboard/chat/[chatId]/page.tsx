...
const Chat: FC<ChatProps> = async ({ params }) => {
  ...
  return (
    <div className='relative flex flex-col items-center justify-between w-full h-screen max-h-screen'>
      <div className='static top-0 flex flex-row text-sm items-center justify-between w-full py-2 px-3 max-xl:px-0 max-xl:py-1 backdrop-blur-3xl bg-neutral-100/70 dark:bg-neutral-950/70 z-10'>
