  ...
  return (
    <div className='flex min-h-screen flex-col items-center justify-center p-24'>
      <div className='flex flex-col p-20 border bg-white dark:bg-black border-neutral-200 dark:border-neutral-900 rounded-xl'>
        <h1 className='font-bold text-center text-2xl max-md:text-xl'>
          Login into your sSpace account
        </h1>
          ...
          <Button isLoading={isGitHubLoading} onClick={loginWithGithub}>
            ...
            >
              <path
                ...
                fill={!isGitHubLoading ? '#fff' : '#000'}
              />
            </svg>
            <p className='pl-2'>GitHub</p>
          </Button>

          <Button isLoading={isGoogleLoading} onClick={loginWithGoogle}>
            <svg
              width='20'
              height='20'
              xmlns='http://www.w3.org/2000/svg'
