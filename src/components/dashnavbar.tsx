    ...
    >
      ...
      {!!session && (
        <div className="inline-flex items-center content-center justify-self-end">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="inline-flex items-center justify-center rounded-full hover:text-neutral-600 dark:text-white dark:hover:text-neutral-300 py-2 px-2 ml-1 transition-all ease-in-out duration-200">
